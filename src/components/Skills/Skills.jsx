...
const Skills = () => {
  ...
  Como desarrollador frontend, disfruto creando interfaces de usuario intuitivas y creativas con HTML y React.<br />
  Tengo experiencia en:<br />
  Me esfuerzo para que mis sitios sean responsivos y se adapten a distintos dispositivos. Tengo experiencia en desarrollar componentes avanzados como formularios controlados para creación de productos, inicio de sesión, registro de usuarios y recuperación de contraseñas.<br />
  Utilizo Redux para la gestión del estado y estilizo componentes con CSS, Bootstrap y preprocesadores como Less.<br />
  También tengo experiencia en la integración de APIs RESTful, la implementación de operaciones asíncronas con JavaScript, y la gestión de contenido multimedia con Cloudinary.<br />
