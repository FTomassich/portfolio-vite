      ...
      <div className={styles.container}>
        <div className={styles.item}>
          ...
          <strong className={styles.strong}>
            ...
            Desarrollar componentes avanzados como formularios controlados para creación de productos, inicio de sesión, registro de usuarios y recuperación de contraseñas.<br />
